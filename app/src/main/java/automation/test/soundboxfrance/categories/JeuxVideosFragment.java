...
public class JeuxVideosFragment extends SuperFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        super.soundImage = new Integer[]{R.drawable.crashbandicoot,R.drawable.dovahkiin,R.drawable.andyoudontworryabout,R.drawable.trevordecuve,R.drawable.followthedamntrain,R.drawable.itsmemario ,R.drawable.warneverchanges ,R.drawable.vasuceruntroll,R.drawable.musiquedubus,R.drawable.turkdance,R.drawable.dansesurfortnite,R.drawable.leeroyjenkins,R.drawable.illidan, R.drawable.flossfortnite,R.drawable.electroshuffle,R.drawable.ouistarcraft,R.drawable.travailtermine,R.drawable.coffrezelda, R.drawable.nonmario,R.drawable.squalalanoussommespartis,R.drawable.fusrodah,R.drawable.robloxmort,R.drawable.fievredisco,R.drawable.wasted,R.drawable.missionfailed,R.drawable.mortvivant,R.drawable.belairfortnite,R.drawable.heynikoitsroman,R.drawable.ineedhealing,R.drawable.thorishere,R.drawable.hitminecraft,R.drawable.bonsangquestquonpeutsennuyer,R.drawable.meilleuramifornite,R.drawable.delormerci,R.drawable.bigsmokeorder,R.drawable.rireduroi,R.drawable.welcometobrawlhalla,R.drawable.yourethelastonecompletethemission,R.drawable.easport,R.drawable.megalovania,R.drawable.anucheekybreeky,R.drawable.ragnarlerouge,R.drawable.heylisten,R.drawable.alertemetalgearsolid,R.drawable.perfect,R.drawable.ohshitherewego,R.drawable.kikikimamama,R.drawable.scp096,R.drawable.operationhealth,R.drawable.boitemysteremodezombie,R.drawable.demarragemariokart};
        super.after();
        return view;
    }
}